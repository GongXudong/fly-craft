...
from flycraft.terminations.reach_target_termination import ReachTargetTermination
...
class ReachTargetTerminationTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.reach_target_termination = ReachTargetTermination(
